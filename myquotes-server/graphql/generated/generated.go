...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "User.isLoggedIn":
		if e.complexity.User.IsLoggedIn == nil {
			break
		}

		return e.complexity.User.IsLoggedIn(childComplexity), true
...
func (ec *executionContext) _User_isLoggedIn(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
